...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            nn.BatchNorm1d((1536 + 1) * 2), # Aplica la normalización por lotes sobre una entrada 2D o 3D
            nn.Linear((1536+1) * 2, 500), # nn linear es un módulo que se utiliza para crear una red de alimentación directa de una sola capa con n entradas y m salidas.
            nn.BatchNorm1d(500),
